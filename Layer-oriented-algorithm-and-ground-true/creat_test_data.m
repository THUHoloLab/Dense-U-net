...
figure(8)
imshow(I_new);
filename=['./text_data/hologram/data/data/',num2str(data_count),'.tif'];
...
filename_x=['./text_data/ground_true_text/x_',num2str(data_count),'.txt'];
filename_y=['./text_data/ground_true_text/y_',num2str(data_count),'.txt'];
filename_r=['./text_data/ground_true_text/r_',num2str(data_count),'.txt'];
filename_d=['./text_data/ground_true_text/z_',num2str(data_count),'.txt'];
...
figure(2)
imshow(I_new_1);
filename_1=['./text_data/ground_true/label/label/',num2str(data_count),'.tif'];
